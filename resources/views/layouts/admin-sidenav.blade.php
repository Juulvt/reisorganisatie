<div class="basis-1/6 min-h-full min-w-fit relative">
    ...
    <div class="absolute h-fit min-h-full w-full min-w-fit md:block left-0 top-0 lg:py-5 lg:pl-10 lg:pr-0 bg-white shadow-sm" id="side-nav">
        ...
        <ul class="pl-0 text-sm min-w-fit">
            ...
            <li class="p-3 {{ Request::is('admin') ? 'active' : '' }} min-w-fit">
            ...
            <li class="p-3 {{ (request()->is('admin/booking*')) ? 'active' : '' }} min-w-fit">
            ...
            <li class="p-3 {{ (request()->is('admin/trip*')) ? 'active' : '' }} min-w-fit">
                ...
                <ul id="dropdown-trip" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="#" class="flex items-center p-2 pl-11 w-full text-sm font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Accomodation Types</a>
                    </li>
                </ul>
            </li>
            <li class="p-3 {{ (request()->is('admin/location*')) ? 'active' : '' }} min-w-fit">
            ...
            <li class="p-3 {{ (request()->is('admin/user*')) ? 'active' : '' }} min-w-fit">
                ...
                <ul id="dropdown-users" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="#" class="flex items-center p-2 pl-11 w-full text-sm font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Roles</a>
                    </li>
                </ul>
            </li>
            <li class="p-3 {{ (request()->is('admin/setting*')) ? 'active' : '' }} min-w-fit">
                <a type="button" class="flex justify-center lg:justify-start items-center gap-3 min-w-fit transition duration-75 group" aria-controls="dropdown-settings" data-collapse-toggle="dropdown-settings">
                    <div sidebar-toggle-item class="inline-block w-1/6 text-xl min-w-fit">
