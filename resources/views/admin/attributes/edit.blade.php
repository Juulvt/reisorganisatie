...
<div class="flex flex-col min-h-screen">
    ...
    <div class="flex-1 flex min-h-full">
        ...
        <a href={{ route('admin.attribute.index') }} class="inline-block bg-main py-2.5 w-32 text-center font-bold rounded text-white shadow-md mb-3"><i class="fa-solid fa-left-long"></i> Return</a>
        <div class="bg-white rounded-lg shadow-sm p-5">
                <div class="flex justify-between items-center">
                    <h2 class="text-xl">Edit attribute</h2>
                </div>
                @if ($errors->any())
                ...
                @method('PATCH')
                    <div class="flex justify-start flex-wrap gap-3 py-3">
                        <div class="basis-full flex-1 md:basis-2/6">
                            ...
                            " type="text" id="description" name="description" value='{{$attribute->description}}'>
                        </div>
                    </div>
