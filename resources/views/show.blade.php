...
<div class="absolute w-full">
    <div class="container mx-auto flex justify-center px-50 mb-5 relative">
        <div class="w-2/3 grid grid-cols-2 gap-5 bg-white rounded-xl px-14 py-8 absolute top-negative-1-2">
            <div>
                <h4>{{$trip->name}}</h4>
            ...
            <div class="text-right">
                <a href={{ route('index.show', ['id' => $trip->id])}} class="btn primary">Book now</a>
            </div>
        </div>
    </div>
</div>
